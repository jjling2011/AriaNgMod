        ...
        function (
            ...
            var initCheck = function () {
                ...
                if (!browserFeatures.cookies) {
                    ariaNgLogService.warn(
                        "[root.initCheck] Cookies is not supported!"
                    );
                }
            ...
            $window.addEventListener(
                ...
                function (event) {
                    ...
                    var isTextboxOrTextareaFocus =
                        isAnyTextboxOrTextareaFocus();
                    ...
                    if (
                        ...
                        if (
                            angular.isFunction($rootScope.keydownActions.find)
                        ) {
                        ...
                        if (
                            angular.isFunction($rootScope.keydownActions.delete)
                        ) {
            ...
            aria2TaskService.onConnectionWaitingToReconnect(function () {
                $timeout(function () {
                    if (
                        $rootScope.taskContext.rpcStatus !==
