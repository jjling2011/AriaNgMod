    ...
    angular.module("ariaNg").controller("DownloadListController", [
        ...
        function (
                    ...
                    function (response) {
                        ...
                        if (!response.success) {
                            if (
                                ...
                                aria2RpcErrors.Unauthorized.message
                            ) {
                        ...
                        var isRequestWholeInfo =
                            response.context.requestWholeInfo;
                        ...
                        if (isRequestWholeInfo) {
                            ...
                            if (
                                ...
                                for (
                                    var i = 0;
                                    i < $rootScope.taskContext.list.length;
                                    i++
                                ) {
            ...
            $scope.getFilteredCount = function () {
                let tasks = $rootScope.taskContext.list || [];
                let count = 0;
            ...
            $scope.getSelectedCount = function () {
                return $rootScope.taskContext.getSelectedTaskIds().length;
            };
            ...
            $scope.isSupportDragTask = function () {
                ...
                return (
                    location === "waiting" && displayOrder.type === "default"
                );
            };
